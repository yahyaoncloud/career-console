  ...
  return (
    <div
      className={`
        ...
        bg-white dark:bg-zinc-950 border rounded-lg shadow-xl overflow-hidden
    ...
    >
      {/* Progress bar */}
      {duration > 0 && (
        <div className="absolute top-0 left-0 h-[2px] w-full bg-zinc-100 dark:bg-zinc-800">
          <div
      ...
      <div className="flex items-start gap-3 p-4 pt-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          {t.action && (
            <div className="flex items-center gap-2 mt-2.5">
              <button
                ...
                className={`mono-text text-[10px] px-2.5 py-1 rounded border font-bold cursor-pointer transition-colors ${
                  t.action.variant === 'destructive'
                    ...
                    : 'bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 border-zinc-800 dark:border-zinc-200 hover:opacity-85'
                }`}
              >
                {t.action.label}
              </button>
              <button
                onClick={onDismiss}
                className="mono-text text-[10px] px-2.5 py-1 rounded border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
              >
                Cancel
              </button>
            </div>
        ...
        <button
          onClick={onDismiss}
          className="p-0.5 rounded hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-400 transition-colors cursor-pointer shrink-0"
        >
          <X size={13} />
        </button>
      </div>
